QUnit.test("suggest with one word match", function(assert) {
  var result = suggest({video: "35241509", words: ["нічого", "любові", "ніжності", "ночами", "нічого"]}, ["ночами"]);
...
QUnit.test("suggest with two words match", function(assert) {
  var result = suggest({video: "35241509", words: ["нічого", "любові", "ніжності", "ночами", "нічого"]}, ["ночами", "любові"]);
  assert.deepEqual(result.suggestedWords, ["нічого", "ніжності", "нічого"]);
  assert.strictEqual(result.combo, null)
});

QUnit.test("suggest with all words match", function(assert) {
  var result = suggest({video: "35241509", words: ["нічого", "любові", "ніжності", "ночами", "нічого"]}, ["нічого", "любові", "ніжності", "ночами", "нічого"]);
...
QUnit.test("suggest with non-match word", function(assert) {
  var result = suggest({video: "35241509", words: ["нічого", "любові", "ніжності", "ночами", "нічого"]}, ["абрікосик1"]);
  assert.deepEqual(result.suggestedWords, []);
  assert.strictEqual(result.combo, null)
});
