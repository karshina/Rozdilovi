...
if (isset($_GET['img'])) {
  ...
  $index = str_replace('{{IMAGE}}', url_origin($_SERVER, true) . '/' . 'img/og_image.jpg', $index);
  $index = str_replace('{{DESC}}', 'Проект агенції АртПоле. Текст і голос: Сергій Жадан, ідея та візуалізація: Оля Михайлюк, музика: Олексій Ворсоба і Влад Креймер.', $index);
